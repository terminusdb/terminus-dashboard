 ...
 */
const i=r(2),n=r(24);function s(e,t,r){if(this.bindings=e?e.bindings:[],this.query=t||n.query(),this.cursor=0,!r||!r.no_compress){const e=!(!r||!r.context)&&r.context;this.compress(e)}}s.prototype.compress=function(e){e=e||this.query.getContext();for(let t=0;t<this.bindings.length;t++)for(const r of Object.keys(this.bindings[t])){const n=i.shorten(r,e),s="string"==typeof this.bindings[t][r]?i.shorten(this.bindings[t][r],e):this.bindings[t][r];delete this.bindings[t][r],this.bindings[t][n]=s}return this},s.prototype.hasBindings=function(){return!(!this.bindings||!this.count())},s.prototype.getBindings=function(){return this.bindings},s.prototype.getVariableList=function(){return this.bindings&&this.bindings[0]?Object.keys(this.bindings[0]):[]},s.prototype.count=function(){return this.bindings.length},s.prototype.first=function(){return this.cursor=0,this.bindings[0]},s.prototype.last=function(){return this.cursor=this.bindings.length-1,this.bindings[this.bindings.length-1]},s.prototype.next=function(){return this.cursor++,this.bindings[this.cursor]},s.prototype.prev=function(){if(this.cursor>0)return this.cursor--,this.bindings[this.cursor]},s.prototype.sort=function(e,t){this.bindings.sort((r,i)=>this.compareValues(r[e],i[e],t))},s.prototype.compareValues=function(e,t,r="asc"){return e&&t?(void 0!==e["@value"]&&void 0!==t["@value"]&&(e=e["@value"],t=t["@value"]),e>t?r&&"asc"==r?1:-1:t>e?r&&"asc"==r?-1:1:void 0):0},e.exports=s},function(e,t,r){const i=r(26),n=r(28),s=r(30),o=r(32),a=r(34),u=r(36),c=r(5),l=r(7),d={table:function(){return new i},chart:function(){return new o},graph:function(){return new s},chooser:function(){return new n},stream:function(){return new a},document:function(){return new u},loadConfig:function(e){if(e.table)(t=new i).loadJSON(e.table,e.rules);else if(e.chooser){(t=new n).loadJSON(e.chooser,e.rules)}else if(e.graph){(t=new s).loadJSON(e.graph,e.rules)}else if(e.chart){(t=new o).loadJSON(e.chart,e.rules)}else if(e.stream){(t=new a).loadJSON(e.stream,e.rules)}else if(e.frame){var t;(t=new u).loadJSON(e.frame,e.rules)}return t},rule:function(e){return e&&"frame"==e?new l:new c},pattern:function(e){return e&&"woql"==e?(new c).pattern:(new l).pattern},matchRow:function(e,t,r,i){return(new c).matchRow(e,t,r,i)},matchColumn:function(e,t,r){return(new c).matchColumn(e,t,r)},matchCell:function(e,t,r,i,n){return(new c).matchCell(e,t,r,i,n)},matchNode:function(e,t,r,i,n){return(new c).matchNode(e,t,r,i,n)},matchEdge:function(e,t,r,i,n){return(new c).matchPair(e,t,r,i,n)},matchFrame:function(e,t,r){return(new l).testRules(e,t,r)}};e.exports=d},function(e,t,r){
/**
