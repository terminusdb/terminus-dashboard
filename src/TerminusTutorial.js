...
TerminusTutorialLoader.prototype.fetchOptions = function(){
	let cback = this.showTutorialChoices;
	HTMLHelper.loadDynamicScript("tutorials", "https://terminusdb.github.io/terminus-tutorials/seshat-tutorial/script-of-queries.js", cback);
}
...
TerminusTutorialLoader.prototype.getLabelDOM = function(){
	return document.createTextNode("Connect");
}

TerminusTutorialLoader.prototype.getFormFieldDOM = function(ip, fname, ltxt, pholder){
